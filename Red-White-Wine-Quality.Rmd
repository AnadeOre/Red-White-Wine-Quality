...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot() + 
  geom_point(data = rw, aes(x = quality, y = chlorides, color = "r"), alpha = 0.3) +
  geom_point(data = ww, aes(x = quality, y = chlorides, color = "y"), alpha = 0.3) +
  scale_colour_manual(name ="Wine variety", values = c("r" = "#900c28", "y" = "#fdff8b"), labels=c("y" = "White", "r" = "Red")) +
  scale_fill_manual(name ="Wine variety", values = c("r" = "#900c28", "y" = "#fdff8b"), labels=c("y" = "White", "r" = "Red")) +
  labs(x = 'Quality', y = 'Chlorides')

ggplot() + 
  geom_point(data = rw, aes(x = quality, y = density, color = "r"), alpha = 0.3) +
  geom_point(data = ww, aes(x = quality, y = density, color = "y"), alpha = 0.3) +
  scale_colour_manual(name ="Wine variety", values = c("r" = "#900c28", "y" = "#fdff8b"), labels=c("y" = "White", "r" = "Red")) +
  scale_fill_manual(name ="Wine variety", values = c("r" = "#900c28", "y" = "#fdff8b"), labels=c("y" = "White", "r" = "Red")) +
  labs(x = 'Quality', y = 'Density')

ggplot() + 
  geom_point(data = rw, aes(x = quality, y = alcohol, color = "r"), alpha = 0.3) +
  geom_point(data = ww, aes(x = quality, y = alcohol, color = "y"), alpha = 0.3) +
  scale_colour_manual(name ="Wine variety", values = c("r" = "#900c28", "y" = "#fdff8b"), labels=c("y" = "White", "r" = "Red")) +
  scale_fill_manual(name ="Wine variety", values = c("r" = "#900c28", "y" = "#fdff8b"), labels=c("y" = "White", "r" = "Red")) +
...
For either wine varieties there does not seem to be relations between chlorides and density vs quality.
